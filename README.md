...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/freestyle-sh/grata
   cd grata
   ```
...
4. Set up environment variables:
   ...
   ```
   # Database
   DATABASE_URL=postgresql://username:password@localhost:5432/grata
...
```bash
docker run --name grata-redis -p 6379:6379 -d redis
```
...
```env
PREVIEW_DOMAIN=<your-domain> # formatted like grata.app
```
